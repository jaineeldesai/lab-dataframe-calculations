...
Launch `challenge-1.ipynb`, `challenge-2.ipynb`, and `challenge-3.ipynb` in the `code` directory of this lab. Take the exercises following the step-by-step instructions.
